...
class SpaceShip(pygame.sprite.Sprite):
    def __init__(self,path,x_pos,y_pos):
        ...
        self.charged = pygame.image.load('Avoid_Meteors_Assets/spaceship_charged.png')
        
        self.image = self.uncharged
        self.rect = self.image.get_rect(center = (x_pos,y_pos))
        self.shield_surface = pygame.image.load('Avoid_Meteors_Assets/shield.png')
        self.health = 5
...
game_font = pygame.font.Font('Avoid_Meteors_Assets/LazenbyCompSmooth.ttf',40)
score = 0
laser_timer = 0
laser_active = False

spaceship = SpaceShip('Avoid_Meteors_Assets/spaceship.png',640,500)
...
while True: # Game loop
    for event in pygame.event.get(): # Check for events / Player input
        ...
        if event.type == pygame.MOUSEBUTTONDOWN and laser_active:
            new_laser = Laser('Avoid_Meteors_Assets/Laser.png',event.pos,15)
        ...
        if event.type == METEOR_EVENT:
            random_meteor_image = random.choice(('Avoid_Meteors_Assets/Meteor1.png','Avoid_Meteors_Assets/Meteor2.png','Avoid_Meteors_Assets/Meteor3.png'))
